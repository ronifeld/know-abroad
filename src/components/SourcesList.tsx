...
// from. Each source links out — this is deliberately the last thing on the
// page, framed as "verify this yourself," not as a trust badge.
  ...
  return (
    <section className="border-t border-border py-8">
      ...
      <p className="mt-2 text-sm leading-relaxed text-muted">
        ...
        check the linked page directly before relying on any of this.
      </p>
